 ...
 */
    ...
    var inline = makeMap("abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,span,small,strike,strong,sub,sup,textarea,tt,u,var");
